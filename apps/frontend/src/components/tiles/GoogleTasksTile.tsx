...
function GoogleTasksTileInner({ tile }: { tile: TileInstance }) {
  ...
  const loginImplicit = useGoogleLogin({
    flow: 'implicit',
    scope: 'https://www.googleapis.com/auth/keep https://www.googleapis.com/auth/tasks https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/drive.appdata',
